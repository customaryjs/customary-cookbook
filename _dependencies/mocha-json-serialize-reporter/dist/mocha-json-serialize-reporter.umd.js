(function (global, factory) {
	...
	(global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.MochaJsonSerializeReporter = factory());
	...
	const _global_Mocha = Mocha;

	/* globals process */

	var Mocha$1 = _global_Mocha;
	var Base = Mocha$1.reporters.Base;
	var EVENT_RUN_END = 'end';

	/* istanbul ignore if  */
	if (commonjsGlobal.process == null) {
	  commonjsGlobal.process = Mocha$1.process;
	}
	...
	function MochaSetsStateToPending() {
	  if (Mocha$1.prototype.version != null) {
	    return Number(Mocha$1.prototype.version.split('.')[0]) >= 8;
	  }
	  return false;
	}
	...
	var jsonSerializeReporter = JsonSerializeReporter;

	var jsonSerializeReporter$1 = /*@__PURE__*/getDefaultExportFromCjs(jsonSerializeReporter);

	return jsonSerializeReporter$1;
