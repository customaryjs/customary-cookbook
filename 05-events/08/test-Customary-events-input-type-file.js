...
describe(suite.title, async function () {
    ...
    describe('happy day', async function () {
        ...
        it('interact', async function () {
            this.retries(64);
            CT.querySelector('button', picker1).click();
            CT.querySelector('button', picker2).click();
            CT.querySelector('button', picker3).click();
            CT.querySelector('button', picker4).click();
        });
        it('looks good', async function () {
            this.retries(64);
...
//# sourceMappingURL=test-Customary-events-input-type-file.js.map